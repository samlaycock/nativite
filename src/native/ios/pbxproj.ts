...
const UUID = {
  ...
  testHarnessFile: "AA0000000000000000000011",
  ...
  testHarnessBuildFile: "BB0000000000000000000011",
...
export function pbxprojTemplate(
  ...
  const sourcesBuildFiles = [
    ...
    `\t\t${UUID.testHarnessBuildFile} /* NativiteTestHarness.swift in Sources */ = {isa = PBXBuildFile; fileRef = ${UUID.testHarnessFile} /* NativiteTestHarness.swift */; };`,
  ...
  const sourceFileRefs = [
    ...
    `\t\t${UUID.testHarnessFile} /* NativiteTestHarness.swift */ = {isa = PBXFileReference; lastKnownFileType = sourcecode.swift; path = NativiteTestHarness.swift; sourceTree = "<group>"; };`,
